...
export default function RelicsPage() {
  ...
  return (
    <div>
      ...
      <input
        type="text"
        placeholder="搜尋套裝名稱或效果關鍵字…"
        value={search}
        onChange={e => setSearch(e.target.value)}
        className="w-full sm:w-72 mb-4 px-4 py-2 rounded-lg bg-white/5 border border-white/15 text-white placeholder-gray-500 text-sm focus:outline-none focus:border-white/40"
      />
